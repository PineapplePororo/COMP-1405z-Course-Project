...
result = search3.search('peach apple apple apple banana peach peach banana',True)
...
result = search3.search('banana peach tomato tomato pear peach peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear coconut pear apple banana banana peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato apple banana banana tomato banana coconut banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear coconut coconut apple tomato peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana pear pear peach coconut peach banana',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana pear pear peach coconut peach banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear coconut peach peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple peach apple banana peach coconut',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato banana banana peach coconut tomato peach apple',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut tomato apple peach peach banana',True)
if not testingtools.compare_search_results(expected, result):
...
expected = [{'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-1.html', 'title': 'N-1', 'score': 0.02099492456728733}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-4.html', 'title': 'N-4', 'score': 0.015524735848489709}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-3.html', 'title': 'N-3', 'score': 0.013216295889852698}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-0.html', 'title': 'N-0', 'score': 0.010158987971029421}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-9.html', 'title': 'N-9', 'score': 0.008510726413291102}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-12.html', 'title': 'N-12', 'score': 0.008300270253703926}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-20.html', 'title': 'N-20', 'score': 0.007892485331647896}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-6.html', 'title': 'N-6', 'score': 0.007554565208180449}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-15.html', 'title': 'N-15', 'score': 0.007412250626492393}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-42.html', 'title': 'N-42', 'score': 0.006730205640271726}]
result = search3.search('tomato peach tomato coconut tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut apple banana pear peach banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach coconut tomato banana peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana apple peach pear banana peach apple',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut coconut peach tomato pear banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach pear coconut peach banana peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut apple peach banana coconut apple pear tomato',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear coconut pear pear coconut pear pear apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato coconut tomato tomato pear banana peach peach',True)
if not testingtools.compare_search_results(expected, result):
...
expected = [{'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-76.html', 'title': 'N-76', 'score': 0.9995561228928082}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-329.html', 'title': 'N-329', 'score': 0.9988892828640841}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-105.html', 'title': 'N-105', 'score': 0.998544798942508}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-796.html', 'title': 'N-796', 'score': 0.9984716365394537}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-233.html', 'title': 'N-233', 'score': 0.9982082457219194}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-532.html', 'title': 'N-532', 'score': 0.9975431987597079}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-354.html', 'title': 'N-354', 'score': 0.9974897348595452}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-92.html', 'title': 'N-92', 'score': 0.9965178683287363}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-569.html', 'title': 'N-569', 'score': 0.9964826978198248}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-296.html', 'title': 'N-296', 'score': 0.9957016562577593}]
result = search3.search('apple coconut coconut pear peach tomato',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato pear peach banana coconut pear peach peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato peach peach coconut pear apple coconut',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach coconut pear peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato peach apple',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato coconut peach peach pear peach tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana apple apple peach apple tomato pear peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato apple banana coconut peach tomato peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach apple peach coconut apple peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach coconut tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana peach apple tomato coconut coconut apple pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana pear tomato peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach tomato pear tomato tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple banana peach peach tomato coconut peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear pear pear pear peach coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut peach banana pear apple peach banana banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut peach tomato banana banana tomato peach peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple tomato banana tomato banana banana banana peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana peach pear pear peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach tomato peach tomato coconut apple banana tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach pear peach apple',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana tomato peach banana apple tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut coconut coconut tomato apple peach apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana pear banana peach pear apple peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato banana peach peach tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato coconut peach pear banana banana pear peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach apple peach banana coconut apple banana tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana peach tomato peach coconut',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana peach tomato peach coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach coconut tomato tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana banana pear banana peach apple coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach banana coconut peach peach peach pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana peach apple tomato peach tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach tomato tomato pear banana apple apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear peach peach apple tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach pear coconut peach peach',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut pear banana coconut peach banana peach',True)
if not testingtools.compare_search_results(expected, result):
...
expected = [{'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-1.html', 'title': 'N-1', 'score': 0.01990026712213297}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-4.html', 'title': 'N-4', 'score': 0.01516233961797169}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-3.html', 'title': 'N-3', 'score': 0.012656863112068272}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-0.html', 'title': 'N-0', 'score': 0.009542498515062645}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-9.html', 'title': 'N-9', 'score': 0.008383757869645276}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-20.html', 'title': 'N-20', 'score': 0.007702330429590654}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-12.html', 'title': 'N-12', 'score': 0.007598771807920936}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-15.html', 'title': 'N-15', 'score': 0.00740614694983707}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-6.html', 'title': 'N-6', 'score': 0.006613299748389652}, {'url': 'http://people.scs.carleton.ca/~davidmckenney/fruits/N-42.html', 'title': 'N-42', 'score': 0.006590609935960895}]
result = search3.search('peach tomato banana apple peach tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear peach peach coconut tomato tomato apple banana',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach apple peach pear tomato pear',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear pear pear apple tomato peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana banana peach tomato apple pear peach tomato',True)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear tomato banana coconut pear apple banana peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana peach coconut pear coconut pear tomato coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach apple peach apple pear coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach peach peach tomato peach coconut pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana peach coconut banana apple banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear coconut pear pear banana tomato pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach peach pear apple tomato peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach apple pear apple apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach coconut banana apple apple apple banana pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple banana tomato apple coconut apple apple banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple apple peach tomato peach pear peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('peach peach coconut peach tomato pear peach apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato apple apple apple peach apple apple pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut coconut pear coconut coconut banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato coconut peach coconut banana coconut tomato',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana apple peach tomato coconut coconut pear apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut peach coconut coconut apple coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('banana peach pear peach apple peach banana',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear tomato coconut coconut coconut peach coconut peach',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut pear peach apple coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple coconut banana apple coconut pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple pear pear coconut coconut pear pear tomato',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut apple apple tomato banana pear coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('apple coconut banana banana apple coconut coconut pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato pear banana pear pear peach apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('pear peach banana peach coconut tomato peach coconut',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato peach pear apple banana apple',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('coconut tomato coconut coconut peach coconut coconut pear',False)
if not testingtools.compare_search_results(expected, result):
...
result = search3.search('tomato peach pear apple coconut coconut apple banana',False)
if not testingtools.compare_search_results(expected, result):
